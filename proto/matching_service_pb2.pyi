...
class FillResponse(_message.Message):
    ...
    seller_id: str
    engine_id: str
    def __init__(self, fill_id: _Optional[str] = ..., order_id: _Optional[str] = ..., symbol: _Optional[str] = ..., side: _Optional[str] = ..., price: _Optional[float] = ..., quantity: _Optional[float] = ..., remaining_quantity: _Optional[float] = ..., timestamp: _Optional[int] = ..., buyer_id: _Optional[str] = ..., seller_id: _Optional[str] = ..., engine_id: _Optional[str] = ...) -> None: ...
...
class SyncRequest(_message.Message):
    __slots__ = ("symbol", "engine_id")
    SYMBOL_FIELD_NUMBER: _ClassVar[int]
    ENGINE_ID_FIELD_NUMBER: _ClassVar[int]
    symbol: str
    engine_id: str
    def __init__(self, symbol: _Optional[str] = ..., engine_id: _Optional[str] = ...) -> None: ...
