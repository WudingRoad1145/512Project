...
from .order import Order, Fill, Side, OrderStatus
...
class OrderBook:
    ...
    def _match_order_at_price(self, incoming_order: Order, price: float) -> Dict[str, list]:
        incoming_fills = []
        resting_fills = []
        ...
        if incoming_order.side == Side.BUY:
            ...
            for resting_order in orders[:]:
                ...
                incoming_fills.append((incoming_order.client_id, Fill(
                ...
                resting_fills.append((resting_order.client_id, Fill(
                    fill_id=f"FILL;incoming:{incoming_order.order_id};resting:{resting_order.order_id}",
